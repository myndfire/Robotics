...
public:
    ...
    enum FrameSize : uint8_t {
        ...
        QCIF         = 2,       // 176×144
        HQVGA        = 3,       // 240×176
        SIZE_240X240 = 4,       // 240×240
        QVGA         = 5,       // 320×240  (default)
        CIF          = 6,       // 400×296
        HVGA         = 7,       // 480×320
        VGA          = 8,       // 640×480
        SVGA         = 9,       // 800×600
        ...
        UXGA         = 13,      // 1600×1200
        FHD          = 14,      // 1920×1080
        P_HD         = 15,      // 720×1280 (portrait)
        P_3MP        = 16,      // 864×1536
        QXGA         = 17,      // 2048×1536  (3 MP)
        QHD          = 18,      // 2560×1440
        WQXGA        = 19,      // 2560×1600
        P_FHD        = 20,      // 1080×1920 (portrait)
        QSXGA        = 21,      // 2560×2048  (5 MP)
        INVALID      = 22,      // invalid / end
    };
